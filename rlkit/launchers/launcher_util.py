...
def create_log_dir(exp_prefix, exp_id=None, seed=None, base_log_dir=None, algo_name=None):
    """
    ...
    if seed is not None:
        log_dir = os.path.join(base_log_dir, exp_prefix.replace("_", "-"), algo_name, f"seed{seed}", exp_name)
    else:
        log_dir = os.path.join(base_log_dir, exp_prefix.replace("_", "-"), algo_name, exp_name)
...
def setup_logger(
    ...
    if first_time:
        log_dir = create_log_dir(exp_prefix, exp_id=exp_id, seed=seed,
                                 base_log_dir=base_log_dir, algo_name=algo_name)
